...
const TABLES = [
  ...
  ["boosts", "Module 3-9 · boosts (subject kinds + resolved targeting)"],
  ["boost_reviews", "Module 9 · every approve/reject/pause/stop, attributed"],
  ["boost_reminders", "Module 9 · 1-tap renew notices actually sent"],
